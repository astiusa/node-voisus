...
api.getFeatures = function(cb) {
  async.waterfall([
    ...
    function(result, cb) {
      var data = {
        acenet: result.acenet.enabled,
        prc117f: result.prc117f.enabled,
        debugwebsocket: result.debugwebsocket.enabled,
        networkcredits: result.networkcredits.enabled,
        crewintercom: result.crewintercom.enabled,
        urc200: result.urc200.enabled,
        sincgars: result.sincgars.enabled,
        simscribeallpdus: result.simscribeallpdus.enabled,
        multiserver: result.multiserver.enabled,
        acexmpp: result.acexmpp.enabled,
        radiomonautotune: result.radiomonautotune.enabled,
        simscribevbs: result.simscribevbs.enabled,
        disreplay: result.disreplay.enabled,
        tocnetcau: result.tocnetcau.enabled,
        acechat: result.acechat.enabled,
        prc119: result.prc119.enabled

...
var _getWaveformsById = function(scn, waveformId, cb) {
  var data = {};
  async.waterfall([
    function(cb) {
      util.request(scn.scnUrl, 'get', cb);
    ...
    function(result, cb) {
      util.request(result.waveforms, 'get', cb);
    },
    function(result, cb) {
      for(var i in result.items) {
        if(result.items[i].id === waveformId)
        {
          delete result.items[i].parent;
          result.items[i].url = result.items[i].self;
          delete result.items[i].self;
...
api.getRolesCommpanel = function(roleId, cb) {
  var scn = this;
  var data = [];
  async.waterfall([
    function(cb) {
    ...
    function(result, cb) {
      util.request(result.commpanel_tmpl, 'get', cb);
    },
    function(result, cb) {
      for(var i in result.items) {
        delete result.items[i].parent;
...
api.postRolesCommpanel = function(roleId, data, cb) {
  var scn = this;
  async.waterfall([
    function(cb) {
      _getRolesById(scn, roleId, cb);
    ...
    function(result, cb) {
      util.request(result.commpanel_tmpl, 'post', JSON.stringify(data), cb);
    },
    function(result, cb) {
      delete result.parent;
      delete result.self;
...
api.putWaveforms = function(waveformId, data, cb) {
  var scn = this;
  async.waterfall([
    function(cb) {
      _getWaveformsById(scn, waveformId, cb);
    },
    function(result, cb) {
      util.request(result.url, 'put', JSON.stringify(data), cb);
    },
...
api.postWaveforms = function(data, cb) {
  var scn = this;
  async.waterfall([
    function(cb) {
      util.request(scn.scnUrl, 'get', cb);
    ...
    function(result, cb) {
      util.request(result.waveforms, 'post', JSON.stringify(data), cb);
    },
    function(result, cb) {
      delete result.parent;
      delete result.self;
...
api.delWaveforms = function(waveformId, cb) {
  var scn = this;
  async.waterfall([
    function(cb) {
      _getWaveformsById(scn, waveformId, cb);

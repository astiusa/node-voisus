...
api.putDis = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.self, 'put', JSON.stringify(data), cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.postDis = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.self, 'post', JSON.stringify(data), cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.delDis = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.self, 'delete', JSON.stringify(data), cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);

...
api.createScenario = function(scenarioName, cb) {
  ...
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.scenarios, 'post', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.runScenario = function(scenario, cb) {
  ...
  async.waterfall([
    ...
    function(result, cb) {
      ...
      util.request(result.sessions, 'post', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.runScenarioByName = function(scenarioName, cb) {
  ...
  async.waterfall([
    ...
    function(result, cb) {
      ...
      util.request(sessionURL, 'post', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.putDisDomains = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.items[0].self, 'get', cb);
    },
    function(result, cb) {
      util.request(result.self, 'put', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.postDisDomains = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.self, 'post', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.delDisDomains = function(scenario, data, cb) {
  async.waterfall([
    function(cb) {
      util.request(scenario, 'get', cb);
    },
    ...
    function(result, cb) {
      util.request(result.self, 'del', cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
...
api.putDis = function(scenario, data, cb) {
  async.waterfall([
    ...
    function(result, cb) {
      util.request(result.dis, 'put', data, cb);
    }
  ], function(err, result) {
    if(err) {
      return cb(err);
